...
class Player():
    ...
    def update(self, game_over):
        ...
        dy = 0
        walk_cooldown = 5
        coll_thresh = 20  # collision threshold
        ...
        if game_over == 0:
            ...
            for platform in platform_group:
                ...
                if platform.rect.colliderect(self.rect.x, self.rect.y, self.width, self.height):
                    ...
                    if abs((self.rect.top + dy) - platform.rect.bottom) < coll_thresh:
                        self.vel_y = 0
                        dy = platform.rect.bottom - self.rect.top
                    # check if above platform
                    elif abs((self.rect.bottom + dy) - platform.rect.top) < coll_thresh:
            ...
            draw_text('GAME OVER!', font, blue, (screen_width // 2) - 130, screen_height // 2)
            if self.rect.y > 200:
                self.rect.y -= 5

        # draw player on to screen
        screen.blit(self.image, self.rect)
        # pygame.draw.rect(screen,  (255, 255, 255), self.rect, 2) # draws white around blocks
